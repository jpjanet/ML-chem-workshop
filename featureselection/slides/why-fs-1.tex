...
\begin{center}
	...
	\visible<1-10>{\node [rectangle,minimum width=4.4cm,minimum height =4.2cm,anchor=center, 
		path picture= {\node at (path picture bounding box.center){\includegraphics[width=4.5cm]{featureselection/figures/fig10.pdf}{}};}](ff) at (0,0){};
	...
	\visible<10->{\node [rectangle,,minimum width=6cm,minimum height =6cm,fill=white,text width = 6cm,anchor=center,path picture= {\node at (path picture bounding box.center){\includegraphics[width=6cm]{featureselection/figures/rmse}{}};}] (tb) at (-5.0,-0.15) {};}
	\visible<11->{\node [rectangle,,minimum width=4.5cm,minimum height =5cm,text width = 4.85cm,anchor=center,path picture= {\node at (path picture bounding box.center){\includegraphics[width=4.5cm]{featureselection/figures/cv}{}};}] (tb) at (0,-0.15) {};}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
