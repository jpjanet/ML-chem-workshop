...
\visible<4->{$$GD\rightarrow\Big(\frac{\partial Loss}{\partial W}\Big)\rightarrow \text{all training data}$$}
\visible<5->{$$SGD\rightarrow\Big(\frac{\partial Loss}{\partial W}\Big)\rightarrow \text{one/few examples}\rightarrow \text{MUCH noisier!}\rightarrow \text{less stuck}$$}