\begin{align*}
 \mathcal{E}(\hat{f}) -\mathcal{E}(f^{*})  &=  \only<1->{\color{blue}}\left[\mathcal{E}(\hat{f})-\mathcal{E}(f^{\dagger})\right]\only<1->{\color{black}} +  \only<1->{\color{red}}\left[\mathcal{E}(f^{\dagger})-\mathcal{E}(f^{*})\right] \only<1->{\color{black}} 
\end{align*}
