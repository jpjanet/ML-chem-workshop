\begin{center}
	...
	\only<1->{\node[anchor =north west] (text) at (-5.25,3.25){\begin{minipage}{10.0cm}
			...
			\end{minipage}};}
	\visible<1->{\node[anchor=east] (east) at (5.5,-1.5){\includegraphics[width=5.5cm]{representations/images/HDAD}};}
	\visible<1->{\node[anchor=west] (figure) at (-5.5,-1.15){\includegraphics[width=5.5cm]{representations/images/HDAD_performance.jpg}};}
	\end{tikzpicture}
\end{center}
